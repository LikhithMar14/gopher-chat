...
func Seed(db *sql.DB, authService *service.AuthService, postService *service.PostService, commentService *service.CommentService, logger *zap.SugaredLogger) error {
	...
	for _, userTemplate := range userTemplates {
		createdUser, err := authService.Create(ctx, models.RegisterUserRequest{
